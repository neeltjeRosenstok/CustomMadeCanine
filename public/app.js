...
function trainerView(){
 ...
 return `<section class="screen trainer-screen">
  ...
  <div class="dashboard-taskbar dashboard-six">
    <button class="task-button task-book" onclick="openTrainerAdmin('clients')"><span>Book for client</span><span>＋</span></button>
