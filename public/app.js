...
function reportCellValue(k,v){
 if((k==='start_at'||k==='end_at'||k==='vaccination_verified_at')&&v){
  const str=String(v),d=str.slice(0,10),t=str.slice(11,16);
  return t?`${d} ${t}`:d;
 }
