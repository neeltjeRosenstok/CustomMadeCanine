...
function clientAdminView(){
 ...
 const filtered=rows.filter(x=>(filter==='all'||x.client_status===filter)&&(activityFilter==='all'||x.activity_status===activityFilter));
